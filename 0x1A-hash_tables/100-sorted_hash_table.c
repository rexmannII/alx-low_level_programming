...
/**
 * shash_tables_create - create a sorted hash table
...
/**
 * shash_table_set - set a key to a value in the hash table
...
/**
 * shash_table_deletes - deletes a sorted hash table
 * @ht: hash table to choice
 *
 * Return: void
 */
